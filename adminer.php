...
* @return string
*/
function script_src($js_code) {
    $nonce = nonce(); // Get the nonce attribute from the nonce() function
    return "<script type='text/javascript' $nonce>" . $js_code . "</script>";
}
...
<?php
	...
	*/
	function navigation($missing) {
		...
		?>
<h1>
<?php echo 'WSO'; ?> <span class="version"><?php echo $VERSION; ?></span>
...
EOT;
?>
<?php echo script_src($js_functions); ?>
<?php echo script_src($js_editing); ?>
<?php if ($adminer->head()) { ?>
